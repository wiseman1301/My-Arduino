...
#include <iarduino_RTC.h>
 iarduino_RTC time(RTC_DS1302, 5, 7, 6); // подключаем RTC модуль на базе чипа DS1302, указывая выводы Arduino подключённые к выводам модуля RST, CLK, DAT
...
void setup() {
    ...
    Serial.begin(9600);
    time.begin();
    time.settime(0,23,21,19,03,20,4);  // 0  сек, 23 мин, 21 час, 19, марта, 2020 года, четверг
}
void loop(){
